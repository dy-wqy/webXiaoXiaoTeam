...
function check()
{
 ...
 if (document.formAdd.huifu.value=="")
  {
    alert("回复不能为空！");
    document.formAdd.huifu.focus();
    return false;
  }

document.formAdd.submit();
}
</script><form name="formAdd" method="post" action="liuyanupdate" class="form-horizontal" role="form">
<fieldset> <legend>回复留言</legend>

<input type="hidden" name="id" value="${c.id}"/>

<div class="form-group">
    <label class="col-sm-2 control-label" for="huifu">回复</label>
      <div class="col-sm-4">
<input name="huifu" type="text" id="huifu" class="form-control"  value="${c.huifu}" >
 </div>
	</div>
