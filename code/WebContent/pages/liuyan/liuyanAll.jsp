...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/liuyanAll">
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="huifu" id="huifu" class="form-control" placeholder="回复"/>
	</div>
  </div>
...
<td>${c.huifu}</td>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/liuyanAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
