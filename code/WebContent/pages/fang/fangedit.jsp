...
</script><form name="formAdd" method="post" action="fangupdate" class="form-horizontal" role="form">
<fieldset> <legend>修改房屋信息</legend>
...
<div class="form-group">
   ...
   <option value="${s.name}"<c:if test="${s.name eq c.area}"> selected</c:if>>${s.name}</option>
</c:forEach>
		 </select> 
		 </div>
   </div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="xiaoqu">小区名称</label>
      <div class="col-sm-4">
<input name="xiaoqu" type="text" id="xiaoqu"  value="${c.xiaoqu}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="chanquan">产权年限</label>
      <div class="col-sm-4">
<input name="chanquan" type="text" id="chanquan"  value="${c.chanquan}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="niandai">建筑年代</label>
      <div class="col-sm-4">
<input name="niandai" type="text" id="niandai"  value="${c.niandai}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="zhuangxiu">装修程度</label>
      <div class="col-sm-4">
<input name="zhuangxiu" type="text" id="zhuangxiu"  value="${c.zhuangxiu}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="dizhi">地址</label>
      <div class="col-sm-4">
<input name="dizhi" type="text" id="dizhi"  value="${c.dizhi}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="lianxiren">联系人</label>
      <div class="col-sm-4">
<input name="lianxiren" type="text" id="lianxiren"  value="${c.lianxiren}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="gongjiao">公车路线</label>
      <div class="col-sm-4">
<input name="gongjiao" type="text" id="gongjiao"  value="${c.gongjiao}"  class="form-control" >
 </div>
	</div>
<div class="form-group">
