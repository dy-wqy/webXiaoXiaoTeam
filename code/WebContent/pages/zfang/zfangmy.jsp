...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/zfangmy">
...
<td>
 ...
 <a href="<%=path %>/zfangedit?id=${c.id}&forword=zfangmy" class="btn btn-default">修改</a> |
 <a href="zfangdel?id=${c.id}&forword=zfangmy" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/zfangmy?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
