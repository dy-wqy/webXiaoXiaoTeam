...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/kanfangAll">
...
<script>laydate.render({elem: '#sdate'});</script>
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="sname" id="sname" class="form-control" placeholder="中介"/>
	</div>
  </div>
...
<td>${c.zt}</td>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/kanfangAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
