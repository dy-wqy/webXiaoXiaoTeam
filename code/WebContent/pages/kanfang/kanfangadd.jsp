...
</script><form name="formAdd" method="post" action="<%=path %>/kanfanginsert" class="form-horizontal" role="form">
	<fieldset> <legend>添加预约看房</legend>	
<input name="zfang" type="hidden" value="${param.id}">
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="kanfangmy"/>
